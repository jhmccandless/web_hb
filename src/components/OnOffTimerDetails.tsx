  ...
  return (
    <div className="timer-wrapper-details">
      ...
      <IncrementTime
        ...
        stylingProp="timer-item-1-1 timer-item-left timer-item-2-1-land"
      />
      <IncrementTime
        action={"rest"}
        currentAct={props.currentAct}
        ...
        stylingProp="timer-item-1-3 timer-item-right timer-item-2-3-land"
      />
      <IncrementCounter
        whichCounter={"sets"}
        counter={props.setsCounter}
        stylingProp="timer-item-2-2 timer-item-3-2-land"
      />
    </div>
  );
}
